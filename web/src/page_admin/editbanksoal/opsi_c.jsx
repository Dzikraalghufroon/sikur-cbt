...
const Editor = () => {
    ...
    const handleUpload = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`${import.meta.env.VITE_SERVER}/modul-update-opsi_c`, { name, opsi_c });
        ...
        <div>
            ...
            <div className={styles.editor}>
                <form onSubmit={handleUpload}>
                    <h2>Masukkan opsi_c</h2>
                    {renderEditor(textInputRef, setopsi_c, "Ketik teks di sini...")}
