...
const Editor = () => {
    ...
    const handleUpload = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`${import.meta.env.VITE_SERVER}/modul-update-opsi_d`, { name, opsi_d });
        ...
        <div>
            ...
            <div className={styles.editor}>
                <form onSubmit={handleUpload}>
                    <h2>Masukkan opsi_d</h2>
                    {renderEditor(textInputRef, setopsi_d, "Ketik teks di sini...")}
