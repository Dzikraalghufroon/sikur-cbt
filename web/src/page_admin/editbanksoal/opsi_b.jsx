...
const Editor = () => {
    ...
    const handleUpload = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.put(`${import.meta.env.VITE_SERVER}/modul-update-opsi_b`, { name, opsi_b });
        ...
        <div>
            ...
            <div className={styles.editor}>
                <form onSubmit={handleUpload}>
                    <h2>Masukkan opsi_b</h2>
                    {renderEditor(textInputRef, setopsi_b, "Ketik teks di sini...")}
