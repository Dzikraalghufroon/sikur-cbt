                ...
                <tr className='ujang'>
                  <td className='ujang'>
                    <div className={Styles.logo}>
                      <p className={Styles.h5}>Status : Aktif</p>
                      <h5 className={Styles.h5}>{kelasItem.name}</h5>
                    </div>
                    <Link to={`/Ujian/${kelasItem.id}`}>
                      <button className={Styles.button}>Mulai Penilaian</button>
                    </Link>
                  </td>
                </tr>
              ))
